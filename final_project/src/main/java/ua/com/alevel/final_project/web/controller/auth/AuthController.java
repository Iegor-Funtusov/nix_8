package ua.com.alevel.final_project.web.controller.auth;
...
import ua.com.alevel.final_project.config.security.SecurityService;
import ua.com.alevel.final_project.facade.AuthValidatorFacade;
...
import ua.com.alevel.final_project.util.SecurityUtil;
import ua.com.alevel.final_project.web.controller.AbstractController;
...
public class AuthController extends AbstractController {
    ...
    public String registration(@ModelAttribute("authForm") AuthDto authForm, BindingResult bindingResult, Model model) {
        ...
        securityService.autoLogin(authForm.getUsername(), authForm.getPasswordConfirm());
        return redirectProcess(model);
    }
